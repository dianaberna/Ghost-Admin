...
export default class GhBrandSettingsFormComponent extends Component {
    ...
    async updateAccentColor(event) {
        ...
        if (newColor === '') {
            ...
            this.settings.errors.add('accentColor', this.intl.t('branding.Please select an accent color'));
        ...
        if (newColor.match(/#[0-9A-Fa-f]{6}$/)) {
            ...
            this.settings.errors.add('accentColor', this.intl.t('branding.Please enter a color in hex format'));
            this.settings.hasValidated.pushObject('accentColor');
        }
    }
