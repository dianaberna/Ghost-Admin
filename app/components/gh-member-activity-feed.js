...
class MemberActivity {
    ...
    eventProperties = {
        sent: {
            icon: 'send-email',
            iconClass: 'midgrey',
            tooltip: 'members.Received email'
        },
        opened: {
            icon: 'eye',
            iconClass: 'green-d2',
            tooltip: 'members.Opened email'
        },
        failed: {
            icon: 'cross-circle',
            iconClass: 'red-d2',
    ...
    get tooltip() {
        return this.intl(this.eventProperties[this.event].tooltip);
    }
    ...
    get message() {
        ...
        return this.intl(this.eventProperties[this.event].message);
    }
}
